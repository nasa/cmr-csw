...
RSpec.describe 'GetDomain http POST "DescribeRecord.typeName" request parameter success scenarios', :type => :request do
...
<GetDomain
   ...
   xsi:schemaLocation="http://www.opengis.net/cat/csw/2.0.2 CSW-discovery.xsd">
    <ParameterName>DescribeRecord.typeName</ParameterName>
</GetDomain>
    eos
